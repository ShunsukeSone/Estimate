...
namespace Estimate.Models
{
    ...
    {
        public string Estimate_No { get; set; }                     /*伝票番号*/
        public string Estimate_Zip { get; set; }                   /*見積先郵便番号*/
        ...
        public string Estimate_Name { get; set; }                   /*見積先企業名*/
        public List<Meisai> Meisai { get; set; }                    /*明細リスト*/

        public Estimates() { }
        public Estimates(
            string _Estimate_No,
            string _Estimate_Zip,
    ...
    public class Meisai
    {
        ...
        public decimal Tanka { get; set; }                          /*単価*/
